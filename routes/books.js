...
function saveCover(book, coverEncoded) {
  if (!coverEncoded || typeof coverEncoded !== 'string') {
    return;
  }

  console.log('coverEncoded:', coverEncoded); // Add this line to log the coverEncoded value
  ...
  try {
    ...
    console.error('Error parsing cover JSON:', err);
  }
}
